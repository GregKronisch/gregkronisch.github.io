...
GoPro_map <- leaflet(options = leafletOptions(zoomControl = FALSE)) %>%
  ...
  addCircleMarkers( # add points from data.frame
    data = GoPro,
      lng = ~Longitude,
      lat = ~Latitude,
    color = ~Color,
    fillOpacity = 1,
    popup = ~paste0("Direction: ", Direction, "<br>",
                    Latitude, " ,", Longitude),
    label = ~paste0("Direction: ", Direction),
    group = "GoPros") %>%

  addCircleMarkers( # add points manually
    data= data.frame(
      lng = c(-68.49053,-68.49481,-68.49260,
              -68.49139,-68.49579,-68.50065),
      lat = c( 44.73494, 44.73989, 44.73503,
               44.73659, 44.73776, 44.74542),
      label = c("Reef", "Dead Fish?", "Potential Staging Area",
  ...
  # setVView(lat = 44.734, lng = -68.49, zoom = 16) %>%
  addMouseCoordinates()
